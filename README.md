...
| Language-Specific Errors   | `404`                   | Errors will be returned in the language specified by the <br> `Accept-Language` header (e.g., `en` or `de`). | Check the `Accept-Language` header and adjust for the desired language. | `GET /api/users/{id}`   | `Accept-Language` header             |
